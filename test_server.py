...
class SchemaMigrationTests(unittest.TestCase):
    ...
    def test_v10218_operational_fixes_are_release_gated(self):
        ...
        self.assertIn("APP_VERSION = '10.9.3-production-hardening'", server)
        ...
        self.assertIn('v10-9-3-production-hardening', sw)
    ...
    def test_v1030_decision_intelligence_is_live_and_operational(self):
        ...
        self.assertIn('V10.9.3 · Production Hardened', html)
