...
EXPECTED_VERSION='10.7.0-live-notifications-final-release'
...
if STRICT_PRODUCTION:
    def pages_check():
        ...
        if status == 200 and 'مساحة العمل التنفيذية' in text and '10-7-0-live-notifications-final-release' in text:
            return 'current'
        return None
