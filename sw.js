'use strict';
const CACHE_NAME = 'asas-lims-pwa-v8-1-0';
const APP_SHELL = ['./','./index.html','./style.css?v=8-1-0','./app-password.js?v=8-1-0','./i18n.js?v=8-1-0','./runtime-config.js?v=8-1-0','./manifest.webmanifest','./logo.jpg'];
