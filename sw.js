'use strict';
const CACHE_NAME = 'asas-lims-pwa-v10-3-0-decision-intelligence';
const APP_SHELL = ['./','./index.html','./style.css?v=10-3-0-decision-intelligence','./app-password.js?v=10-3-0-decision-intelligence','./branch-map.js?v=10-3-0-decision-intelligence','./i18n.js?v=10-3-0-decision-intelligence','./runtime-config.js?v=10-3-0-decision-intelligence','./field-test-guide.html','./manifest.webmanifest','./logo.png','./asas-home-banner.png','./asas-home-banner-mobile.png','./engineering-pages-bg.jpg','./whatsapp-logo.svg','./telegram-logo.svg'];
