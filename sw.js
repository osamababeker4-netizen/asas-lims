'use strict';
const CACHE_NAME = 'asas-lims-pwa-v8-3-1-user-fix';
const APP_SHELL = ['./','./index.html','./style.css?v=8-3-1-user-fix','./app-password.js?v=8-3-1-user-fix','./branch-map.js?v=8-1-3-branches','./i18n.js?v=8-3-1-user-fix','./runtime-config.js?v=8-1-1','./manifest.webmanifest','./logo.jpg'];
